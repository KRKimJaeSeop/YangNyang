...
public class DialogUnitEditor : ChildAssetEditorWindow
{
    [Serializable]
    ...
    void OnGUI()
    {
        base.CheckAndLoadAsset(DialogTableUnit.ASSET_PATH);
    ...
    {
        _tbUnit = AssetDatabase.LoadAssetAtPath(path, typeof(DialogTableUnit)) as DialogTableUnit;
        if (_tbUnit != null)
        {
