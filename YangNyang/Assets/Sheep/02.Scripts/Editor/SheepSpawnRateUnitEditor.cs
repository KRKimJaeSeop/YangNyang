...
public class SheepSpawnRateUnitEditor : ChildAssetEditorWindow
{
    [Serializable]
    ...
    void OnGUI()
    {
        base.CheckAndLoadAsset(SheepSpawnRateTableUnit.ASSET_PATH);
    ...
    {
        _tbUnit = AssetDatabase.LoadAssetAtPath(path, typeof(SheepSpawnRateTableUnit)) as SheepSpawnRateTableUnit;
        if (_tbUnit != null)
        {
