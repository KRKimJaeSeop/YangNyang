...
public class CurrencyUnitEditor : ChildAssetEditorWindow
{
    [Serializable]
    ...
    void OnGUI()
    {
        base.CheckAndLoadAsset(CurrencyTableUnit.ASSET_PATH);
    ...
    {
        _tbUnit = AssetDatabase.LoadAssetAtPath(path, typeof(CurrencyTableUnit)) as CurrencyTableUnit;
        if (_tbUnit != null)
        {
