...
public class EventSheepUnitEditor : ChildAssetEditorWindow
{
    [Serializable]
    ...
    private EventSheepTableUnit _tbUnit;



    void OnGUI()
    {
        base.CheckAndLoadAssetWithID(EventSheepTableUnit.ASSET_PATH);
    ...
    {
        _tbUnit = AssetDatabase.LoadAssetAtPath(path, typeof(EventSheepTableUnit)) as EventSheepTableUnit;
        if (_tbUnit != null)
        {
